...
# edited from https://github.com/allenai/s2-folks/blob/main/examples/python/get_open_access_pdf/simple.py
os.environ['S2_API_KEY'] = 'XBbGPcpPXB5CH0aLSu6BO5fww06zAusz6dFGXqj0'
S2_API_KEY = os.environ['S2_API_KEY'] # 100 requests/second, 'XBbGPcpPXB5CH0aLSu6BO5fww06zAusz6dFGXqj0'
